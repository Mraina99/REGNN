...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(prog='FICT-preprocess',
    ...
    data_f = args.input        #"/N/slate/mraina/Juexin/Eadon/newkidneydata/V10S14-085_XY04_21-0057"       #"datasets/seqFISH/"
    save_f = args.output           # "Benchmark/V10S14-085_XY04_21-0057/data/"
    os.makedirs(save_f,exist_ok=True)
    prefix = "fishformat_"
    threshold_distance = 40
    n_c = 7 
    coordinate_f = os.path.join(data_f,prefix+"countalt.txt")
    expression_f = os.path.join(data_f,prefix+"spa.txt")
    gene_f = os.path.join(data_f,prefix+"genes.txt")
    ...
    fields = split_field(coordinate) #,y_bin = [0])
    fig,ax = plt.subplots()
