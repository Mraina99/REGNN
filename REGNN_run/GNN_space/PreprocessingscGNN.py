...
parser = argparse.ArgumentParser(description='Main Entrance of scGNN, using snippets of process for REGNN as well')
...
def preprocessingCSV(dir, datasetName, csvFilename, delim='comma', transform='log', cellRatio=0.99, geneRatio=0.99, geneCriteria='variance', geneSelectnum=2000, transpose=False, tabuCol=''):
    ...
    print('After preprocessing, {} genes remaining before cutoff'.format(df1.shape[0]))
