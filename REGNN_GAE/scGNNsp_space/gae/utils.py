...
def get_roc_score(emb, adj_orig, edges_pos, edges_neg):
    ...
    """
    print("inf preds: ", (np.isinf(preds_all)).any())
    print("inf labels: ", (np.isinf(labels_all)).any())
    print("Nan preds: ", (preds_all != preds_all).any())
    print(np.count_nonzero(np.isnan(preds_all)))
    print(np.argwhere(np.isnan(preds_all)))
    print("Nan labels: ", (labels_all != labels_all).any())
    """
